...
const fp = (0, _flatpickrDefault.default)(refs.inputEl, options);
function onCloseFunction(date) {
    if (Date.now() > date) (0, _notiflixNotifyAio.Notify).failure("Please choose a date in the future");
    else {
        refs.startButton.disabled = !isDisabled;
        chosenDate = date;
    }
...
},{}]},["8lKsl","1AWyZ"], "1AWyZ", "parcelRequire1851")
